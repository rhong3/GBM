...
def inceptionv2(input,
    ...
    with tf.name_scope(scope, "InceptionV2", [input]):
        ...
        inception_3a_5x5_a = Conv2D(96, (3, 3), padding='same', activation='relu', name='inception_3a/5x5_a',
                                         kernel_regularizer=l2(0.0002))(inception_3a_5x5_reduce)

        inception_3a_5x5_b = Conv2D(96, (3, 3), padding='same', activation='relu', name='inception_3a/5x5_b',
        ...
        inception_3b_5x5_a = Conv2D(96, (3, 3), padding='same', activation='relu', name='inception_3b/5x5_a',
                                         kernel_regularizer=l2(0.0002))(inception_3b_5x5_reduce)

        inception_3b_5x5_b = Conv2D(96, (3, 3), padding='same', activation='relu', name='inception_3b/5x5_b',
        ...
        inception_4a_5x5_a = Conv2D(48, (3, 3), padding='same', activation='relu', name='inception_4a/5x5_a',
                                         kernel_regularizer=l2(0.0002))(inception_4a_5x5_reduce)

        inception_4a_5x5_b = Conv2D(48, (3, 3), padding='same', activation='relu', name='inception_4a/5x5_b',
        ...
        inception_4b_5x5_a = Conv2D(64, (3, 3), padding='same', activation='relu', name='inception_4b/5x5_a',
                                         kernel_regularizer=l2(0.0002))(inception_4b_5x5_reduce)

        inception_4b_5x5_b = Conv2D(64, (3, 3), padding='same', activation='relu', name='inception_4b/5x5_b',
        ...
        inception_4c_5x5_a = Conv2D(64, (3, 3), padding='same', activation='relu', name='inception_4c/5x5_a',
                                         kernel_regularizer=l2(0.0002))(inception_4c_5x5_reduce)

        inception_4c_5x5_b = Conv2D(64, (3, 3), padding='same', activation='relu', name='inception_4c/5x5_b',
        ...
        inception_4d_5x5_a = Conv2D(64, (3, 3), padding='same', activation='relu', name='inception_4d/5x5_a',
                                         kernel_regularizer=l2(0.0002))(inception_4d_5x5_reduce)

        inception_4d_5x5_b = Conv2D(64, (3, 3), padding='same', activation='relu', name='inception_4d/5x5_b',
        ...
        inception_4e_5x5_a = Conv2D(128, (3, 3), padding='same', activation='relu', name='inception_4e/5x5_a',
                                         kernel_regularizer=l2(0.0002))(inception_4e_5x5_reduce)

        inception_4e_5x5_b = Conv2D(128, (3, 3), padding='same', activation='relu', name='inception_4e/5x5_b',
        ...
        inception_5a_5x5_a = Conv2D(128, (3, 3), padding='same', activation='relu', name='inception_5a/5x5_a',
                                         kernel_regularizer=l2(0.0002))(inception_5a_5x5_reduce)

        inception_5a_5x5_b = Conv2D(128, (3, 3), padding='same', activation='relu', name='inception_5a/5x5_b',
        ...
        inception_5b_5x5_a = Conv2D(128, (3, 3), padding='same', activation='relu', name='inception_5b/5x5_a',
                                         kernel_regularizer=l2(0.0002))(inception_5b_5x5_reduce)

        inception_5b_5x5_b = Conv2D(128, (3, 3), padding='same', activation='relu', name='inception_5b/5x5_b',
        ...
        logits = tf.cond(tf.equal(is_training, tf.constant(True)),
                         lambda: tf.add(loss3_classifier, tf.scalar_mul(tf.constant(0.3),
                                                                             tf.add(loss1_classifier,
                                                                                         loss2_classifier))),
